...
(function() {
  ...
  const T = {
    ...
    'fr': {
      ...
      hero: { badge: 'SUIVRE · ANALYSER · AMÉLIORER', h1a: 'Vos paris.', h1b: 'Vos données.', h1c: 'Votre avantage.', sub: "Betra est la plateforme d'analytiques qui transforme votre historique de paris en aperçus actionnables - un tableau de bord unifié pour chaque bookmaker.", startTracking: 'Commencer le suivi gratuit', seeHow: 'Voir comment ça marche' },
