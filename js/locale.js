...
(function() {
  ...
  const T = {
    ...
    'es-ES': {
      ...
      philosophy: { label: 'La filosofía', title1: 'La mayoría apuesta por instinto.', title2: 'Los mejores apuestan con datos.', quote: '"Lo que se mide se gestiona. La diferencia entre un apostador perdedor y uno constante no es suerte — es información. Betra da a todos acceso al mismo edge de datos que usan los profesionales."', cite: 'Principio fundador de Betra', precision: 'Seguimiento preciso', precisionDesc: 'Cada ticket registrado con contexto completo. Cuotas, stake, casa de apuestas, mercado — sin perder ningún dato.', pattern: 'Detección de patrones', patternDesc: 'Descubre en qué deportes, ligas y tipos de apuesta ganas de verdad — y elimina las fugas.', continuous: 'Mejora continua', continuousDesc: 'Rastrea el ROI en el tiempo. Ve tu ventaja con claridad, adapta tu estrategia y mejora cada mes.', unified: 'Cartera unificada', unifiedDesc: 'Bet365, DraftKings, Bet365 España, FanDuel — todas tus casas de apuestas en un solo hub de analytics.' },
      product: { label: 'El producto', title1: 'Analytics de nivel profesional.', title2: 'Sin complicaciones.', ocr: 'Escaneo OCR de apuestas', ocrDesc: 'Haz una captura de cualquier boleto. Betra lo lee automáticamente — cuotas, stake, patas, todo.', dashboard: 'Panel de analytics completo', dashboardDesc: 'ROI desglosado por deporte, liga, tipo de apuesta y casa. Sabes exactamente dónde ganas.', live: 'Seguimiento de partidos en vivo', liveDesc: "Resultados en tiempo real para cada ticket activo. Ve al momento si vas ganando o perdiendo.", bankroll: 'Gestión del bankroll', bankrollDesc: 'Define un bankroll inicial. Sigue su evolución según se resuelven las apuestas — con historial completo.', multileg: 'Seguimiento de apuestas combinadas', multilegDesc: 'Barras de progreso para acumuladas. Patas ganadas, pendientes, restantes — de un vistazo.', perfOverview: 'Resumen de rendimiento', last30: 'Últimos 30 días', netPnl: 'P&L neto', winRate: 'Tasa de aciertos', pnlTrend: 'Tendencia P&L', activeGames: 'Partidos activos', ticketHistory: 'Historial de boletos', inProgress: 'EN CURSO', won: 'GANADA', lost: 'PERDIDA', ticketFormatInProgress: '@25.4 · €10 · Ganancia potencial: €254', ticketFormatWon: '@17 · €5 · Ganancia: €85', ticketFormatLost: '@1.85 · €30 · Perdido: €72.15', win: 'Ganancia' },
